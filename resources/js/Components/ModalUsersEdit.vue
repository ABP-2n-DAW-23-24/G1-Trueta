...
<template>
    ...
    align-items: baseline;">
                <h2 class="title-edit" style="font-size: 20px;">Editar usuari</h2>
            ...
            <div class="container-modal-edit">
                <div class="center_flex_modal">
                    ...
                    <input type="text" class="input-model" style="    border-radius: 5px;" placeholder="Nom"
                    ...
                    <input type="text" class="input-model" style="    border-radius: 5px" placeholder="Cognoms"
                ...
                <div class="rols">
                    <div class="checkbox-wrapper-46">
                        ...
                        <label for="cbx-46-admin" class="cbx"><span>
                                ...
                                </svg></span><span>Administrador</span>
                        </label>
                    </div>
                    <div class="checkbox-wrapper-46">
