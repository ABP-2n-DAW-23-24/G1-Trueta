...
<div class="box-modal-inputs">
            <div class="center_flex_modal">
                    ...
                    <input class="input-model"  type="text" style="    border-radius: 10px" :placeholder="props.traduccion['name']" v-model="name">
                    <div v-if="message">
                      <p v-if="message.name" class="text_error"  v-for=" (item,index) in message.name"> {{item }} </p>
                    </div>
                
                    <input class="input-model" type="text" style="    border-radius: 10px" :placeholder="props.traduccion['surnames']" v-model="surnames">
    ...
    align-content: center;
    align-items: center;">
                    <input type="email" style="border-radius: 10px;width: 100%;"  :placeholder="props.traduccion['email']"
                        v-model="email">
    ...
    align-content: center;
    align-items: center;">
                    <input type="password" style="border-radius: 10px;width: 100%;" :placeholder="props.traduccion['pass']" 
                        v-model="pass">
                    <div v-if="message">
